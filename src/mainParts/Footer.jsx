        ...
        <footer className="spa-footer">            
            <div className="row">
                ...
                <div className="col-4 poweredBy">
                    <div className="row">
                        <h3 className="d-flex justify-content-center">Powered by</h3>
                    </div>
                    <div className="row">
                    <div class="tech-icons-row d-flex justify-content-center">
                        <img
                        ...
                        <div className="d-flex justify-content-center">
                            <ol className="socialList">
                                ...
                                <li>
                                    ...
                                    </svg><a href="https://github.com/Dackefrsik"> Github</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div className="col-12 d-flex justify-content-center copy">
                <small>&copy; 2026 Developed by Daniel Frisk</small>
            </div>
        </footer>
    )
