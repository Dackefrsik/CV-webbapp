...
function Home({ observer, observer2 }) {
    ...
    return (
        <>
            <div className="bgProfilePicture p-5">
                <div className="container-fluid" id="Home">
                    <div className="row">
                        <div className="col-12 col-md-4 ">
                            <div className="row p-md-3">
                                <div className="d-flex justify-content-center align-items-center profile-margin mt-sm-2 mt-md-5 mb-sm-2 mb-md-0">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-3">
                            <div className="d-flex justify-content-center flex-wrap d-md-block ">
                                <p className="d-md-none textCurrentProject">Current/ Latest Project </p>
                                <p className="d-none d-md-block textCurrentProject">Current Project </p>
                            </div>
