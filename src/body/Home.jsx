                ...
                <div className="container" id="Home">
                    <div className="row">
                        ...
                        <div className="col-12 col-md-8 infoBackground homeText">
                            ...
                            <div className="row">
                                <div className="d-md-block col-12 col-md-3 fontHome textMoveRight infoText opacityBefore">
                                    <p>Bachelor's degree</p>
                                </div>
                                <div className="col-12 col-md-9 fontHome textMoveRight infoText opacityBefore text-justify d-md-block">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4 order-1 order-md-0">
                            <ol className="list-unstyled d-md-flex justify-content-center align-items-center flex-column">
                                <li>
                                    <a href="mailto:danielfrisk21@gmail.com" id="mail" className="divBorder text-decoration-none fs-5 fs-md-4 p-1"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-envelope-at me-1 mb-2" viewBox="0 0 16 16">
                                    ...
                                    </svg>danielfrisk21@gmail.com</a>
                                </li>
                                <li className="mb-1">
                                    <a href="https://www.linkedin.com/in/daniel-frisk-2b1295251/" target="_blank" className="divBorder text-decoration-none fs-5 fs-md-4 socialMediaText pb-1">
                                ...
                                <li>
                                    <a href="https://github.com/Dackefrsik" target="_blank" className="divBorder text-decoration-none fs-5 fs-md-4 socialMediaText pb-1">
                        ...
                        <div className="col-12 col-md-8 d-md-flex justify-content-center fontHome textMoveRight d-block infoText opacityBefore text-justify">
