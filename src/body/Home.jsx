                    ...
                    <div className="row">
                        <div className="col-12 col-md-4 ">
                            <div className="row p-md-3">
                                <div className="d-flex justify-content-center profile-margin mt-sm-2 mt-md-5 mb-sm-2 mb-md-0 appearRight">
                            ...
                            <div className="row">
                                <div className="d-flex justify-content-md-center align-items-center mt-md-0">
                                    <div className="divBorder align-items-center appearRight">
                        ...
                        <div className="col-12 col-md-7 mt-md-5 infoBackground homeText">
                            ...
                            <div className="row">
                                <div className="col-12 fontHome textMoveRight d-block infoText">
